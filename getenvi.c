...
/**
 * _unsetenves - Remove an environment variable
 * @info: Structure containing potential arguments. Used to maintain
 *        constant function prototype.
 *  Return: 1 on delete, 0 otherwise
 * @var: the string env var property
 */
int _unsetenves(info_t *info, char *var)
{
...
/**
 * _setenves - Initialize a new environment variable,
 ...
 *  Return: Always 0
 */
int _setenves(info_t *info, char *var, char *value)
{
	char *buf = NULL;
	list_t *node;
	char *p;
