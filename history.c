...
/**
 *  * write_histories - creates a file, or appends to an existing file
...
/**
 *  * read_histories - reads history from file
 *   * @info: the parameter struct
 *    *
...
/**
 *  * build_history_lists - adds entry to a history linked list
...
/**
 *  * renumber_histories - renumbers the history linked list after changes
 *   * @info: Structure containing potential arguments. Used to maintain
 *    *
